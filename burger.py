...
# if not, create it.
#
# \param path A string object with the pathname.
#
...
# \param data string object to test against
#

def comparefiletostring(filename, data):
	...
	fileref1 = None
	try:
		fileref1 = open(filename, 'r')
		fileOneLines = fileref1.readlines()
		fileref1.close()
	...
	fileTwoLines = data.getvalue().splitlines(True)
